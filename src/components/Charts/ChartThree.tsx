...
const ChartThree: React.FC = () => {
  ...
  const handleReset = () => {
    fetch("https://api.vaccinate-india.in/api/metadata/meta", {
      "headers": {
      ...
      const {
        partially_vaccinated_until_yesterday,
        fully_vaccinated_until_yesterday,
        vaccines_remaining
      } = res
      ...
      let options = {
        ...
        labels: ['Partially Vaccinated', 'Fully Vaccinated', 'Vaccines Remaining'],
        legend: {
          position: 'bottom'
        },
        plotOptions: {
